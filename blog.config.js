...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hx', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '大梦想家', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-orpin-six.vercel.app/about', // 网站地址
